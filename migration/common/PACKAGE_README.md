...
Windows 11 MCP Server for Claude Desktop and Codex Desktop.

This use-only distribution provides constrained DeepSeek tool-building, review,
registration, and verified local execution. DeepSeek is not a document co-author;
